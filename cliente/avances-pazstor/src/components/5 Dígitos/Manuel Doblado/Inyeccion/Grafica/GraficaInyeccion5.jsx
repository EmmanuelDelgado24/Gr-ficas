...
const GraficaInyeccion5 = () => {
  const [data, setData] = useState([]);
    ...
    const intervalo = setInterval(() => {
      ...
      socket.on("connect", () => {
        console.log("Conectado al servidor de WebSockets Inyección 5");
      });
  
      // Escuchar evento específico
      socket.on("actualizar-inyeccion-5digitos", (datos) => {
        console.log("Datos Actualizados en Inyección 5");
    ...
    return () => {
      ...
      socket.off("connect");
      socket.off("actualizar-inyeccion-5digitos");
...
export default GraficaInyeccion5;

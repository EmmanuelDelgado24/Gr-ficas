...
const Montado5L1 = () => {
  ...
  useEffect(() => {
    ...
    socket.on("connect", () => {
      console.log("Conectado al servidor de WebSockets Montado L1");
    });

    // Escuchar evento específico
    socket.on("actualizar-Montado-L1", (datos) => {
      console.log("Datos Actualizados en Montado L1");
    ...
    return () => {
      ...
      socket.off("connect");
      socket.off("actualizar-Montado-L1");

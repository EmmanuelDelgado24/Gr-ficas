...
const Auditoria5L4 = () => {
  const [data, setData] = useState([]);
    ...
    const intervalo = setInterval(() => {
      ...
      socket.on("connect", () => {
        console.log("Conectado al servidor de WebSockets Auditoria L4");
      });
  
      // Escuchar evento específico
      socket.on("actualizar-Auditoria-L4", (datos) => {
        console.log("Datos Actualizados en Auditoria L4");
    ...
    return () => {
      ...
      socket.off("connect");
      socket.off("actualizar-Auditoria-L4");

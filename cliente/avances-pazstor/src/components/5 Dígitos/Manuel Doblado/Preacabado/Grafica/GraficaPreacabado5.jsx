...
const GraficaPreacabado5 = () => {
  const [data, setData] = useState([]);
    ...
    const intervalo = setInterval(() => {
      ...
      socket.on("connect", () => {
        console.log("Conectado al servidor de WebSockets Preacabado 5");
      });
  
      // Escuchar evento específico
      socket.on("actualizar-preacabado-5digitos", (datos) => {
        console.log("Datos Actualizados en Preacabado 5");
    ...
    return () => {
      ...
      socket.off("connect");
      socket.off("actualizar-preacabado-5digitos");
...
export default GraficaPreacabado5;

...
const Adorno5L1 = () => {
  ...
  useEffect(() => {
    ...
    socket.on("connect", () => {
      console.log("Conectado al servidor de WebSockets Adorno L1");
    });

    // Escuchar evento específico
    socket.on("actualizar-Adorno-L1", (datos) => {
      console.log("Datos Actualizados en Adorno L1");
    ...
    return () => {
      ...
      socket.off("connect");
      socket.off("actualizar-Adorno-L1");

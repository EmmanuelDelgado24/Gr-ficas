  ...
  const [data, setData] = useState([]);
    ...
    const intervalo = setInterval(() => {
      if (!socket.connected) {
        ...
        socket.on("connect", () => {
          console.log("Conectado al servidor de WebSockets Suela 5");
        });
    
        // Escuchar evento específico
        socket.on("actualizar-suela-5digitos", (datos) => {
          console.log("Datos Actualizados en Suela 5");
    ...
    return () => {
      ...
      socket.off("actualizar-suela-5digitos");
    };
      }, []);

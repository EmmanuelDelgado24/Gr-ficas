...
const GraficaL4 = () => {
  ...
  useEffect(() => {
    ...
    socket.on("connect", () => {
      console.log("Conectado al servidor de WebSockets L4");
      // console.log(socket.id);
    });

    // Escuchar evento específico
    socket.on("actualizar-Pespunte241", (datos) => {
      console.log("Datos Actualizados en L4");
    ...
    return () => {
      ...
      setLoading(false);
      socket.off("connect");
      socket.off("actualizar-Pespunte241");
    };
  }, []);

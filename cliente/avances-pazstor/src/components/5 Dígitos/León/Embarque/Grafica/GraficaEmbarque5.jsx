...
const GraficaEmbarque5 = () => {
  ...
  useEffect(() => {
    ...
    socket.on("connect", () => {
      console.log("Conectado al servidor de WebSockets Embarque 5");
    });

    // Escuchar evento específico
    socket.on("actualizar-embarque-5digitos", (datos) => {
      console.log("Datos Actualizados en Embarque 5");
    ...
    return () => {
      ...
      socket.off("connect");
      socket.off("actualizar-embarque-5digitos");
...
export default GraficaEmbarque5;

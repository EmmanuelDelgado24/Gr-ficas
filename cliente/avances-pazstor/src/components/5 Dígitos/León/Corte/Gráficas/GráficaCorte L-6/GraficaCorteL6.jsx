...
const GraficaCorteL6 = () => {
  ...
  useEffect(() => {
    ...
    socket.on("connect", () => {
      console.log("Conectado al servidor de WebSockets Corte-L6");
    });

    // Escuchar evento específico
    socket.on("actualizar-CorteL6", (datos) => {
      console.log("Datos Actualizados en Corte-L6");

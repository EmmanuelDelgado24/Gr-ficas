...
const GraficaCorteL4 = () => {
  const [data, setData] = useState([]);
    ...
    const intervalo = setInterval(() => {
      ...
      socket.on("connect", () => {
        console.log("Conectado al servidor de WebSockets Corte-L4");
      });
  
      // Escuchar evento específico
      socket.on("actualizar-CorteL4", (datos) => {
        console.log("Datos Actualizados en Corte-L4");

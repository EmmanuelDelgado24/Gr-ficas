...
const GraficaCorteL5 = () => {
  ...
  useEffect(() => {
    ...
    socket.on("connect", () => {
      console.log("Conectado al servidor de WebSockets Corte-L5");
    });

    // Escuchar evento específico
    socket.on("actualizar-CorteL5", (datos) => {
      console.log("Datos Actualizados en Corte-L5");

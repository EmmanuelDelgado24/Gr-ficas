...
const GraficaCorteL7 = () => {
 const [data, setData] = useState([]);
  ...
  useEffect(() => {
    ...
    socket.on("connect", () => {
      console.log("Conectado al servidor de WebSockets Corte-L7");
    });

    // Escuchar evento específico
    socket.on("actualizar-CorteL7", (datos) => {
      console.log("Datos Actualizados en Corte-L7");

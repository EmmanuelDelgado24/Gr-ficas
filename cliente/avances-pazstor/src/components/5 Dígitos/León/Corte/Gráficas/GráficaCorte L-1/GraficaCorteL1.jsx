...
const GraficaCorteL1 = () => {
  ...
  useEffect(() => {
    ...
    socket.on("connect", () => {
      console.log("Conectado al servidor de WebSockets Corte-L1");
    });

    // Escuchar evento específico
    socket.on("actualizar-CorteL1", (datos) => {
      console.log("Datos Actualizados en Corte-L1");

...
const GraficaCorteL8 = () => {
  ...
  useEffect(() => {
    ...
    socket.on("connect", () => {
      console.log("Conectado al servidor de WebSockets Corte-L8");
    });

    // Escuchar evento específico
    socket.on("actualizar-CorteL8", (datos) => {
      console.log("Datos Actualizados en Corte-L8");

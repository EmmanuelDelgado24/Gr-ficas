...
const GraficaCorteL2 = () => {
  const [data, setData] = useState([]);
    ...
    const intervalo = setInterval(() => {
      ...
      socket.on("connect", () => {
        console.log("Conectado al servidor de WebSockets Corte-L2");
      });
  
      // Escuchar evento específico
      socket.on("actualizar-CorteL2", (datos) => {
        console.log("Datos Actualizados en Corte-L2");

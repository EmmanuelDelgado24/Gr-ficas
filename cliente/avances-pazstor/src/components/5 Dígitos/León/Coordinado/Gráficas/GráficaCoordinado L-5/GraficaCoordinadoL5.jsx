...
const GraficaCoordinadoL5 = () => {
  ...
  useEffect(() => {
    ...
    socket.on("connect", () => {
      console.log("Conectado al servidor de WebSockets L5 coordinado");
      // console.log(socket.id);
    });

    // Escuchar evento específico
    socket.on("actualizar-CoordinadoL5", (datos) => {
      console.log("Datos Actualizados en L5");
    ...
    return () => {
      ...
      setLoading(false);
      socket.off("connect");
      socket.off("actualizar-CoordinadoL5");
    };
  }, []);
...
export default GraficaCoordinadoL5;

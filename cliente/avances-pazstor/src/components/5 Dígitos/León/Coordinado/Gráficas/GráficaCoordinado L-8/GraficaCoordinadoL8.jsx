...
const GraficaCoordinadoL8 = ({ onTotalChange }) => {
  ...
  useEffect(() => {
    ...
    socket.on("connect", () => {
      console.log("Conectado al servidor de WebSockets Coordinado-L8");
    });

    // Escuchar evento específico
    socket.on("actualizar-CoordinadoL8", (datos) => {
      console.log("Datos Actualizados en Coordinado-L8");
    ...
    return () => {
      ...
      socket.off("connect");
      socket.off("actualizar-CoordinadoL8");
...
export default GraficaCoordinadoL8;

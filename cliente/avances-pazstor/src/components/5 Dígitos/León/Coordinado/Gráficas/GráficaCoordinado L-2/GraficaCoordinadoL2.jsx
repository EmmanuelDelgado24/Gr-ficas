...
const GraficaCoordinadoL2 = ({ onTotalChange }) => {
  ...
  useEffect(() => {
    ...
    socket.on("connect", () => {
      console.log("Conectado al servidor de WebSockets Coordinado-L2");
    });

    // Escuchar evento específico
    socket.on("actualizar-CoordinadoL2", (datos) => {
      console.log("Datos Actualizados en Coordinado-L2");
    ...
    return () => {
      ...
      socket.off("connect");
      socket.off("actualizar-CoordinadoL2");
...
export default GraficaCoordinadoL2;

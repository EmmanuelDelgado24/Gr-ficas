...
const GraficaCoordinadoL7 = () => {
  ...
  useEffect(() => {
    ...
    socket.on("connect", () => {
      console.log("Conectado al servidor de WebSockets Coordinado-L7");
    });

    // Escuchar evento específico
    socket.on("actualizar-CoordinadoL7", (datos) => {
      console.log("Datos Actualizados en Coordinado-L7");
    ...
    return () => {
      ...
      socket.off("connect");
      socket.off("actualizar-CoordinadoL7");
...
export default GraficaCoordinadoL7;

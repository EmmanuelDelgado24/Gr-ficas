...
const GraficaCoordinadoL6 = ({ onTotalChange }) => {
  ...
  useEffect(() => {
    ...
    socket.on("connect", () => {
      console.log("Conectado al servidor de WebSockets Coordinado-L6");
    });

    // Escuchar evento específico
    socket.on("actualizar-CoordinadoL6", (datos) => {
      console.log("Datos Actualizados en Coordinado-L6");
    ...
    return () => {
      ...
      socket.off("connect");
      socket.off("actualizar-CoordinadoL6");
...
export default GraficaCoordinadoL6;

...
const GraficaCoordinadoL4 = ({ onTotalChange }) => {
  const [data, setData] = useState([]);
    ...
    const intervalo = setInterval(() => {
      ...
      socket.on("connect", () => {
        console.log("Conectado al servidor de WebSockets Coordinado-L4");
      });
  
      // Escuchar evento específico
      socket.on("actualizar-CoordinadoL4", (datos) => {
        console.log("Datos Actualizados en Coordinado-L4");
    ...
    return () => {
      ...
      socket.off("connect");
      socket.off("actualizar-CoordinadoL4");
...
export default GraficaCoordinadoL4;

...
const GraficaCoordinadoL1 = () => {
  ...
  useEffect(() => {
    ...
    socket.on("connect", () => {
      console.log("Conectado al servidor de WebSockets Coordinado-L1");
    });

    // Escuchar evento específico
    socket.on("actualizar-CoordinadoL1", (datos) => {
      console.log("Datos Actualizados en Coordinado-L1");
    ...
    return () => {
      ...
      socket.off("connect");
      socket.off("actualizar-CoordinadoL1");
...
export default GraficaCoordinadoL1;

...
const Auditoria5L8 = () => {
  ...
  useEffect(() => {
    ...
    socket.on("connect", () => {
      console.log("Conectado al servidor de WebSockets L8 Auditoria");
      // console.log(socket.id);
    });

    // Escuchar evento específico
    socket.on("actualizar-Auditoria-L8", (datos) => {
    ...
    return () => {
      ...
      setLoading(false);
      socket.off("connect");
      socket.off("actualizar-Auditoria-L8");
    };
  }, []);

...
const GraficaPespunte4L8 = () => {
  ...
  useEffect(() => {
    ...
    socket.on("connect", () => {
      console.log("Conectado al servidor de WebSockets 4L8");
      // console.log(socket.id);
    });

    // Escuchar evento específico
    socket.on("actualizar-4D-MaquilaL8", (datos) => {              //Fetch?
      console.log("Datos Actualizadosen 4L8");
    ...
    return () => {
      ...
      setLoading(false);
      socket.off("connect");
      socket.off("actualizar-4D-MaquilaL8");
    };
  }, []);
...
export default GraficaPespunte4L8;

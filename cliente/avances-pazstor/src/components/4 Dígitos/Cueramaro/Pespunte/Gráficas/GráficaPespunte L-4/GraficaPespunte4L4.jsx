...
const GraficaPespunte4L4 = () => {
  ...
  useEffect(() => {
    ...
    socket.on("connect", () => {
      console.log("Conectado al servidor de WebSockets 4L4");
      // console.log(socket.id);
    });

    // Escuchar evento específico
    socket.on("actualizar-4D-Pespunte241", (datos) => {
      console.log("Datos Actualizadosen 4L4");
...
export default GraficaPespunte4L4;

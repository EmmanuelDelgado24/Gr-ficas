...
//     socket.on("connect", () => {
//       console.log("Conectado al servidor de WebSockets 4L7");
//       // console.log(socket.id);
//     });

//     // Escuchar evento específico
//     socket.on("actualizar-4D-Pespunte242", (datos) => {       //Fetch?
//       console.log("Datos Actualizadosen 4L7");
...
//       setLoading(false);
//       socket.off("connect");
//       socket.off("actualizar-4D-Pespunte241");
//     };
//   }, []);
...
// export default GraficaPespunte4L7;

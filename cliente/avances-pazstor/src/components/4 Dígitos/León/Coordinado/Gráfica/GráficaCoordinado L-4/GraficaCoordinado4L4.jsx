...
const GraficaCoordinado4L4 = () => {
  ...
  useEffect(() => {
    ...
    socket.on("connect", () => {
      console.log("Conectado al servidor de WebSockets 4L4 coordinado");
      // console.log(socket.id);
    });

    // Escuchar evento específico
    socket.on("actualizar-4D-CoordinadoL4", (datos) => {
      console.log("Datos Actualizados en 4L4");
    ...
    return () => {
      ...
      setLoading(false);
      socket.off("connect");
      socket.off("actualizar-4D-CoordinadoL4");
    };
  }, []);
...
export default GraficaCoordinado4L4;

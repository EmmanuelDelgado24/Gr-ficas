...
const GraficaCoordinado4L8 = () => {
  ...
  useEffect(() => {
    ...
    socket.on("connect", () => {
      console.log("Conectado al servidor de WebSockets 4L8 coordinado");
      // console.log(socket.id);
    });

    // Escuchar evento específico
    socket.on("actualizar-4D-CoordinadoL8", (datos) => {
      console.log("Datos Actualizados en 4L8");
    ...
    return () => {
      ...
      setLoading(false);
      socket.off("connect");
      socket.off("actualizar-4D-CoordinadoL8");
    };
  }, []);
...
export default GraficaCoordinado4L8;

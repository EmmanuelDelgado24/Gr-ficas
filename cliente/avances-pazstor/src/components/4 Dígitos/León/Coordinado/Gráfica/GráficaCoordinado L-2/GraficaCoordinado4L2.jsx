...
const GraficaCoordinado4L2 = () => {
  ...
  useEffect(() => {
    ...
    socket.on("connect", () => {
      console.log("Conectado al servidor de WebSockets 4L2 coordinado");
      // console.log(socket.id);
    });

    // Escuchar evento específico
    socket.on("actualizar-4D-CoordinadoL2", (datos) => {
      console.log("Datos Actualizados en 4L2");
    ...
    return () => {
      ...
      setLoading(false);
      socket.off("connect");
      socket.off("actualizar-4D-CoordinadoL2");
    };
  }, []);
...
export default GraficaCoordinado4L2;

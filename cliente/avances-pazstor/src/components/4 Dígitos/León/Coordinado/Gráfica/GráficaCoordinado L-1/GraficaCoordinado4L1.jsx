...
const GraficaCoordinado4L1 = () => {
  ...
  useEffect(() => {
    ...
    socket.on("connect", () => {
      console.log("Conectado al servidor de WebSockets 4L1 coordinado");
      // console.log(socket.id);
    });

    // Escuchar evento específico
    socket.on("actualizar-4D-CoordinadoL1", (datos) => {
      console.log("Datos Actualizados en 4L1");
    ...
    return () => {
      ...
      setLoading(false);
      socket.off("connect");
      socket.off("actualizar-4D-CoordinadoL1");
    };
  }, []);
...
export default GraficaCoordinado4L1;

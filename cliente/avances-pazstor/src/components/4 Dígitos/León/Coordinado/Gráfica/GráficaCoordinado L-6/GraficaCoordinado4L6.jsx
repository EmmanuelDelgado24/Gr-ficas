...
const GraficaCoordinado4L6 = () => {
  ...
  useEffect(() => {
    ...
    socket.on("connect", () => {
      console.log("Conectado al servidor de WebSockets 4L6 coordinado");
      // console.log(socket.id);
    });

    // Escuchar evento específico
    socket.on("actualizar-4D-CoordinadoL6", (datos) => {
      console.log("Datos Actualizados en 4L6");
    ...
    return () => {
      ...
      setLoading(false);
      socket.off("connect");
      socket.off("actualizar-4D-CoordinadoL6");
    };
  }, []);
...
export default GraficaCoordinado4L6

...
const GraficaCoordinado4L5 = () => {
  ...
  useEffect(() => {
    ...
    socket.on("connect", () => {
      console.log("Conectado al servidor de WebSockets 4L5 coordinado");
      // console.log(socket.id);
    });

    // Escuchar evento específico
    socket.on("actualizar-4D-CoordinadoL5", (datos) => {
      console.log("Datos Actualizados en 4L5");
    ...
    return () => {
      ...
      setLoading(false);
      socket.off("connect");
      socket.off("actualizar-4D-CoordinadoL5");
    };
  }, []);
...
export default GraficaCoordinado4L5;

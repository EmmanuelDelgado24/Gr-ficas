...
const GraficaCoordinado4L7 = () => {
  ...
  useEffect(() => {
    ...
    socket.on("connect", () => {
      console.log("Conectado al servidor de WebSockets 4L7 coordinado");
      // console.log(socket.id);
    });

    // Escuchar evento específico
    socket.on("actualizar-4D-CoordinadoL7", (datos) => {
      console.log("Datos Actualizados en 4L7");
    ...
    return () => {
      ...
      setLoading(false);
      socket.off("connect");
      socket.off("actualizar-4D-CoordinadoL7");
    };
  }, []);
...
export default GraficaCoordinado4L7

...
const GraficaCorte4L5 = () => {
  ...
  useEffect(() => {
    setLoading(true);
    fetch("http://localhost:3000/avances/CorteL5-4")
      .then((response) => {
        if (!response.ok) {
  ...
  return (
    <div>
      {loading ? (
        ...
        <div className="max-w-lg p-6 bg-white border border-gray-800 rounded-lg shadow-sm dark:bg-gray-800 dark:border-dark-700">
          <div>

...
const GraficaCorte4L1 = () => {
  ...
  useEffect(() => {
    ...
    socket.on("connect", () => {
      console.log("Conectado al servidor de WebSockets 4L1 corte");
      // console.log(socket.id);
    });

    // Escuchar evento específico
    socket.on("actualizar-4D-CorteL1", (datos) => {
      console.log("Datos Actualizadosen 4L1");
    ...
    return () => {
      ...
      setLoading(false);
      socket.off("connect");
      socket.off("actualizar-4D-CorteL1");
    };
  }, []);
...
export default GraficaCorte4L1;
...
const GraficaPespunte4L5 = () => {
  ...
  useEffect(() => {
    ...
    socket.on("connect", () => {
      console.log("Conectado al servidor de WebSockets 4L5");
      // console.log(socket.id);
    });

    // Escuchar evento específico
    socket.on("actualizar-4D-Pespunte243", (datos) => {        //Fetch?
      console.log("Datos Actualizadosen 4L5");
    ...
    return () => {
      ...
      setLoading(false);
      socket.off("connect");
      socket.off("actualizar-4D-Pespunte243");
    };
  }, []);
...
export default GraficaPespunte4L5;

...
const AuditoriaL64 = ({onTotalChange}) => {
    ...
    useEffect(() => {
        ...
        socket.on("connect", () => {
            console.log("Conectado al servidor de WebSockets Auditoria");
        });

        // Escuchar evento específico
        socket.on("actualizar-Auditoria-4", (datos) => {
            console.log("Datos Actualizados en Auditoria L64");

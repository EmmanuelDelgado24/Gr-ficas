...
const AdornoL64 = ({onTotalChange}) => {
    ...
    useEffect(() => {
        ...
        socket.on("connect", () => {
            console.log("Conectado al servidor de WebSockets Adorno");
        });

        // Escuchar evento específico
        socket.on("actualizar-Adorno-4", (datos) => {
            console.log("Datos Actualizados en Adorno L64");

...
export const PageEmbarqueMD = () => {
  useEffect(() => {
      // Emit para solicitar embarque
      socket.emit("iniciar-verificacion", "embarque");
    }, []);
  return (
    <div>
      <br/><br/>
      <section>
      <div className="flex">
              <p className="titulo-produccion w-full">PRODUCCIÓN EMBARQUE </p>
              &nbsp;&nbsp;
              <Reloj/>
            </div>

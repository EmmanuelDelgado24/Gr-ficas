...
export const PagePreacabado = () => {
  useEffect(() => {
      // Emit para solicitar embarque
      socket.emit("iniciar-verificacion", "preacabado");
    }, []);
  return (
    <div>
      <br/><br/>
      <section>
      <div className="flex">
              <p className="titulo-produccion w-full">PRODUCCIÓN PREACABADO </p>
              &nbsp;&nbsp;
              <Reloj/>
            </div>

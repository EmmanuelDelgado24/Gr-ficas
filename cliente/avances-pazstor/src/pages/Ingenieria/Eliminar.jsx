    ...
    if (confirmacion) {
      ...
      try {
        ...
        const res = await fetch(
          ...
          `https://gr-ficas.onrender.com/avances/ModelosPespunte/${modeloBusqueda}/${departamento}`,
          //`http://192.168.17.24:3000/avances/ModelosPespunte/${modeloBusqueda}/${departamento}`, 
          {
            method: "DELETE", 
          }
        ...
        alert(`Registro del modelo ${modeloBusqueda} eliminado exitosamente.`);
        setModeloBusqueda(""); 
        setLinea("");
        setEstilo("");
        setProceso("");
    ...
    <>
      ...
      <div className="flex items-center justify-center bg-gray-100">
        <div className="bg-white rounded-2xl shadow-lg p-8 w-full max-w-3xl">
          <h5 className="text-4xl text-center">Eliminar Modelo</h5>
          <br />

  ...
  async function obtenerMinutaje( departamento, modelo) {
    try {
      const res = await fetch(
        ...
        `https://avances-pazstor.online/avances/ModelosPespunte?departamento=${departamento}&modelo=${modelo}`
      );
      if (!res.ok) {
  ...
  async function obtenerMinutajeCorte( departamento, modelo, subdepto) {
    try {
      const res = await fetch(
        ...
        `https://avances-pazstor.online/avances/ModelosCorte?departamento=${departamento}&modelo=${modelo}&subdepto=${subdepto}`
      );
      console.log(res);
      if (!res.ok) {
        const errorData = await res.json();
  ...
  const handleReflejarMeta = async () => {
    ...
    try {
      const res = await fetch(
        ...
        "https://avances-pazstor.online/avances/ReflejarMeta",

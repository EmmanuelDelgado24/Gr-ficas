...
export const PageBusqueda5 = () => {
  ...
  const ConsultarGrafica = async (fechaInicio, fechaFin) => {
    ...
    const apiUrl = `https://avances-pazstor.online/avances/BusquedaFecha5?depto=${departamentoKey}&subdepto=${selectedSubOption}&dateStart=${fechaInicio}&dateEnd=${fechaFin}`;

...
export const PageBusqueda = () => {
  ...
  const ConsultarGrafica = async (fechaInicio, fechaFin) => {
    ...
    const apiUrl = `https://avances-pazstor.online/avances/BusquedaFecha?depto=${departamentoKey}&subdepto=${selectedSubOption}&dateStart=${fechaInicio}&dateEnd=${fechaFin}`;
    try {
